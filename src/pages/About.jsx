    ...
    <div className=''>
      ...
      <section className='bg-richblack-700'>
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
            ...
            <div className="md:h-[70px] lg:h-[150px]"></div>
            <div className="absolute bottom-0 left-1/2 translate-x-[-50%] translate-y-[30%] hidden lg:grid grid-cols-3 gap-5 w-full px-4">
              {[BannerImage1, BannerImage2, BannerImage3].map((img, idx) => (
                <img
                  ...
                  alt={`banner-${idx + 1}`}
                  loading="lazy"
                  className="rounded-md object-cover w-full max-w-[300px] h-auto transition-opacity duration-500"
                />
              ))}
            </div>

            {/* Mobile View */}
            <div className="absolute bottom-[-50px] left-1/2 translate-x-[-50%] translate-y-[30%] shadow-md lg:hidden w-[80%]">
              <img
                src={BannerImage2}
                alt="banner-mobile"
                loading="lazy"
                className="rounded-md object-cover w-full transition-opacity duration-500"
              />
            </div>
        </div>
      </section>
