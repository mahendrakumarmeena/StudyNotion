...
const timeline = [
     ...
     },
     {
        Logo: Logo3,
        heading: "Flexibility",
        Description: "The abiliity to switch is an Importent skills",
     },
     {
        Logo: Logo4,
        heading: "Solve the Problems",
        Description: "Code way to a solution",
     }
]
             ...
             {/* left part  */}
              ...
              <div className='relative shadow-blue-200'>
                    ...
                    >
                           ...
                           <div className='flex flex-row items-center gap-3 border-r border-caribbeangreen-300 px-7'>
