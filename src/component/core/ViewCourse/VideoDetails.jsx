...
//     const { courseId , sectoinId, subSectionId} = useParams();
...
//             if(!courseId && !sectoinId && !subSectionId){
//                 navigate(`/dashboard/enrolled-courses`);
//             }
//             else{

//                 const filteredData = courseSectionData.filter( (course) => course._id === sectoinId);


//                 const filteredVideoData = filteredData?.[0]?.subSectoin.filter( (data) => data._id === subSectionId);
...
//               ]._id
//             navigate(
//               `/view-course/${courseId}/section/${sectoinId}/sub-section/${nextSubSectionId}`
//             )
//           } else {
...
//             ]._id
//           navigate(
//             `/view-course/${courseId}/section/${sectoinId}/sub-section/${prevSubSectionId}`
//           )
//         } else {
...
//                                             <div className='flex justify-center items-center'>
//                                                 {
//                                                     !completedLectures.include(videoData._id) && (
//                                                         <button onClick={ () => { handleLectureCompletion()}} className='border-y-yellow-100 text-richblue-900 absolute top-[20%] hover:scale-90 z-20 font-medium md:text-sm px-4 rounded-md '>Mark as Completed</button>
//                                                     )
//                                                 }
//                                             </div>
//                                             {
