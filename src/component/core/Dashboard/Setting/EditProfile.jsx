            ...
            <div className='flex flex-col md:flex-row gap-5'>
              ...
              <label className='w-full' >
                ...
                <input
                  ...
                  className='form-style w-full placeholder:uppercase placeholder:text-sm placeholder:tracking-wider text-richblack-600'
                ...
                >

                  {
                    genders.map((gender, ind) => (
                      <option className='text-richblack-500' key={ind} value={gender} > {gender} </option>
                    ))
                  }
                </select>
              </label>
